...
<img src={user}/><span className={classes.text}>Account</span>
<img src={check}/>
        </Grid>
        <Grid item  xs={4}  className={classes.div}>
        <img src={shop}/><span className={classes.text}>Bussiness Information</span>
<img src={check}/>
        </Grid>
        <Grid item  xs={4}  className={classes.div}>
        <img src={review}/><span className={classes.text}>Application Review</span>
        </Grid>
    </Grid>
